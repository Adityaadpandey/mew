  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-[#C10801] to-[#F16001] text-white shadow-md shadow-[#E85002]/20 hover:shadow-lg hover:shadow-[#E85002]/30 hover:from-[#A00701] hover:to-[#D15001]",
        "gradient-outline":
          "border-2 border-[#E85002] bg-transparent text-[#E85002] hover:bg-[#E85002]/10 dark:hover:bg-[#E85002]/20",
        premium:
          "bg-gradient-to-r from-[#C10801] via-[#E85002] to-[#F16001] text-white shadow-lg shadow-[#E85002]/25 hover:shadow-xl hover:shadow-[#E85002]/35 hover:scale-[1.02] active:scale-[0.98]",
        "premium-dark":
          "bg-gradient-to-r from-neutral-900 to-neutral-800 text-white shadow-lg border border-neutral-700 hover:border-[#E85002]/50 hover:shadow-[#E85002]/10",
      },
      size: {
